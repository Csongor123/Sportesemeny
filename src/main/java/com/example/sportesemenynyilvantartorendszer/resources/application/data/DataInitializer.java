package com.example.sportesemenynyilvantartorendszer.resources.application.data;
...
public class DataInitializer {
    ...
    public void initializeData(Connection connection) {
        try {
            ...
            // Sample events
            statement.executeUpdate("INSERT INTO event (name, description, event_date, location, max_participants, registration_deadline) " +
                    "VALUES " +
            ...
            // Sample participants
            statement.executeUpdate("INSERT INTO participant (first_name, last_name, email, phone, date_of_birth) " +
                    "VALUES " +
            ...
            statement.executeUpdate("INSERT INTO participant_events (participant_id, event_id, registration_date, status) " +
                    "VALUES " +
    ...
    public static void main(String[] args) {
        // This would typically connect to the database and call initializeData
        System.out.println("Database initialization would happen here");
    }
}
